...
import { O as promptAccountId, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-AOU0sR5E.js";
import { t as promptChannelAccessConfig } from "./setup-group-access-Dz4Z8Sy-.js";
import "./setup-BLf5KHrP.js";
import { o as isPrivateNetworkOptInEnabled } from "./ssrf-policy-DqwSPpuy.js";
...
import { r as moveSingleMatrixAccountConfigToNamedAccount, t as resolveMatrixSetupDmAllowFrom } from "./setup-dm-policy-DPWWZV3_.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-jY1Rqb7I.js";
import { n as updateMatrixAccountConfig } from "./config-update-CT7GPA1F.js";
import { n as validateMatrixHomeserverUrl, t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-Dblwrjr4.js";
import { n as ensureMatrixSdkInstalled, r as isMatrixSdkAvailable } from "./deps-NEFEaTca.js";
...
async function promptMatrixAllowFrom(params) {
	...
	while (true) {
		...
		if (pending.length > 0) {
			const { resolveMatrixTargets } = await import("./resolve-targets-CKJBVjkf.js");
	...
	if (accessConfig) if (accessConfig.policy !== "allowlist") next = setMatrixGroupPolicy(next, accessConfig.policy, params.accountId);
		...
		if (accessConfig.entries.length > 0) try {
			...
			for (const entry of accessConfig.entries) {
				...
				const { listMatrixDirectoryGroupsLive } = await import("./directory-live-BU2WoQi5.js");
...
const matrixOnboardingAdapter = {
	...
	afterConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-c5Fu6JUE.js");
