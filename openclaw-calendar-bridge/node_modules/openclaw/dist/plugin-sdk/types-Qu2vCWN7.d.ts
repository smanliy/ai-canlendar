...
import { a as SourceReplyDeliveryMode, c as InputProvenance, d as ReplyPayload, n as GetReplyOptions, o as UserTurnTranscriptRecorder, r as PartialReplyPayload, s as PromptImageOrderEntry } from "./types-CVgEq9rw.js";
import { a as SupplementalContextFacts, g as InboundEventKind, i as MsgContext, m as PluginHookChannelContext, n as InboundSourceModality, o as CommandTurnContext, r as MentionSource, s as CommandTurnKind, t as FinalizedMsgContext } from "./templating-BduwHz8v.js";
import { In as SilentReplyConversationType, i as OpenClawConfig, pt as TalkProviderConfig, sn as CliBackendConfig, t as ConfigFileSnapshot } from "./types.openclaw-BOp7Uumg.js";
...
import { a as AuthProfileFailureReason, c as OAuthCredential, i as AuthProfileCredential, o as AuthProfileIdRepairResult, r as AuthProfileBlockedSource, s as AuthProfileStore, t as ApiKeyCredential } from "./types-DrQN0wLK.js";
import { f as MediaUnderstandingProvider } from "./types-Bk51q9rq.js";
...
import { d as UnifiedModelCatalogEntry, f as UnifiedModelCatalogKind, h as PluginConfigUiHint, u as PluginKind } from "./manifest-registry-BHpzJG0O.js";
import { t as JsonSchemaObject } from "./json-schema.types-z_ZXZBRr.js";
import { P as MessageReceipt } from "./types-Bymrn94a.js";
import { _ as chunkTextWithMode, g as chunkText, h as chunkMarkdownTextWithMode, m as chunkMarkdownText, n as ChannelOutboundAdapter, p as chunkByNewline, v as resolveChunkMode, y as resolveTextChunkLimit } from "./outbound.types-BobmxhAf.js";
import { i as WizardPrompter } from "./prompts-DgKIGa-v.js";
import { t as OperatorScope } from "./operator-scopes-Phea7r7e.js";
import { t as ChannelPlugin$1 } from "./types.plugin-z6MxzsLN.js";
import { n as PluginMetadataSnapshot, t as PluginMetadataRegistryView } from "./plugin-metadata-snapshot.types-BP-3EWtu.js";
import { t as ConfigWriteAfterWrite } from "./runtime-snapshot-D_Eur9vS.js";
import { n as ConfigReplaceResult, t as ConfigMutationBase } from "./config-B_YN3wdA.js";
import { i as resolveStateDir } from "./paths-Bsx-e4mF.js";
...
import { Ai as AuthStorage, Ci as ModelRegistry$1 } from "./index-DtrVNP6F.js";
import { s as LogLevel } from "./subsystem-n4Y4vCcQ.js";
import { t as OpenClawAgentDatabase } from "./openclaw-agent-db-B-F-AnOy.js";
import { t as ProviderAuthEvidence } from "./provider-env-vars-C5natbZd.js";
import { o as resolveStorePath, r as resolveSessionFilePath } from "./sessions-mSPf7kCs.js";
import { c as EmbeddedAgentExecutionPhase } from "./store-DDNXK4HG.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-DZhrVvBP.js";
import { N as resolveAgentDir, P as resolveAgentWorkspaceDir } from "./agent-scope-B0kFtj44.js";
import { a as createAckReactionHandle, c as shouldAckReaction, d as resolveAgentIdentity, f as resolveEffectiveMessagesConfig, o as removeAckReactionAfterReply, p as resolveHumanDelayConfig, s as removeAckReactionHandleAfterReply } from "./ack-reactions-CimBP7NY.js";
...
import { _ as ImageGenerationSourceImage, c as ImageGenerationOutputFormat, f as ImageGenerationProviderOptions, h as ImageGenerationResolution, i as ImageGenerationNormalization, l as ImageGenerationProvider, n as ImageGenerationBackground, p as ImageGenerationQuality, r as ImageGenerationIgnoredOverride, t as GeneratedImageAsset } from "./types-DgNzIIlD.js";
import { d as VideoGenerationResolution, n as VideoGenerationIgnoredOverride, o as VideoGenerationNormalization, p as VideoGenerationSourceAsset, s as VideoGenerationProvider, t as GeneratedVideoAsset } from "./types-BPfzfzxz.js";
import { c as MusicGenerationProvider, f as MusicGenerationSourceImage, o as MusicGenerationNormalization, r as MusicGenerationIgnoredOverride, s as MusicGenerationOutputFormat, t as GeneratedMusicAsset } from "./types-BrLKYsXT.js";
import { n as RuntimeWebFetchMetadata, r as RuntimeWebSearchMetadata } from "./command-secret-gateway-DWc39COr.js";
import { C as SecretInputMode, n as GatewayRequestHandler, v as AgentEventPayload, x as onAgentEvent, y as AgentEventStream } from "./types-OyR6M8gf.js";
...
import { a as MediaUnderstandingRuntime } from "./runtime-types-BuLSHUgo.js";
import { r as EmbeddingProviderAdapter } from "./embedding-providers-CE0VE8qb.js";
import { d as MemoryPromptSectionBuilder, o as MemoryFlushPlanResolver, r as MemoryCorpusSupplement, s as MemoryPluginCapability, u as MemoryPluginRuntime } from "./memory-state-De6AJ1jI.js";
...
import { Zt as TalkTransport, a as DiagnosticEventPayload, i as DiagnosticEventMetadata, o as DiagnosticEventPrivateData, r as DiagnosticEventInput } from "./diagnostic-events-B_e55ceW.js";
import { o as TranscriptSourceProvider$1 } from "./provider-types-DYx3R9EA.js";
import { a as ResponsePrefixContext, s as TypingCallbacks } from "./reply-prefix-Co1968-i.js";
import { n as ReadChannelAllowFromStoreForAccount$1, r as UpsertChannelPairingRequestForAccount$1 } from "./pairing-store.types-DD4_xUHp.js";
import { a as MatchesMentionWithExplicit$1, i as MatchesMentionPatterns$1, t as BuildMentionRegexes$1 } from "./mentions.types-DIiniPA-.js";
import { n as RecordInboundSession$1, t as InboundLastRouteUpdate } from "./session.types-CXZfGgFp.js";
import { t as hasControlCommand } from "./command-detection-Cb4gxN2b.js";
import { t as ResolveMarkdownTableMode } from "./markdown-tables.types-DgNxXLyN.js";
import { t as convertMarkdownTables } from "./tables-BBMGs0qO.js";
import { i as buildAgentSessionKey, o as resolveAgentRoute } from "./resolve-route-BrpCd5WI.js";
import { t as buildPairingReply } from "./pairing-messages-BhDXyYRO.js";
...
import { n as resolveChannelGroupPolicy, r as resolveChannelGroupRequireMention } from "./group-policy-CO4Rr4fw.js";
import { n as createInboundDebouncer, r as resolveInboundDebounceMs } from "./inbound-debounce-QsHT2VV6.js";
import { r as resolveCommandAuthorizedFromAuthorizers } from "./command-gating-pUtyEXB1.js";
import { a as OutboundDeliveryQueuePolicy, n as DurableFinalDeliveryRequirement, r as DurableFinalDeliveryRequirements, t as DeliverOutboundPayloadsParams } from "./deliver-2x6_7Sfn.js";
import { i as createChannelReplyPipeline, n as CreateChannelReplyPipelineParams } from "./reply-pipeline-D6CD_jvS.js";
...
//#endregion
export { OpenClawPluginService as $, isToolWrappedWithBeforeToolCallHook as $a, SpeechProviderResolveConfigContext as $c, ProviderResolveExternalAuthProfilesContext as $d, REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ as $i, formatFastModeCommandOptions as $l, PluginRuntime as $n, normalizeBatchBaseUrl as $o, CommandSessionMetadataChange as $r, ContextEngineMaintenanceResult as $s, ProviderModelSelectedContext as $t, resolveProfileUnusableUntilForDisplay as $u, OpenClawPluginDefinition as A, AgentHarnessDeliveryDefaults as Aa, DetachedTaskLifecycleRuntime as Ac, resolveAuthProfileDisplayLabel as Ad, CliBackendAuthEpochMode as Ai, WebFetchProviderId as Al, ProviderResolvePromptOverlayContext as An, normalizeEmbeddingModelWithPrefixes as Ao, ConversationFacts as Ar, DEFAULT_HEARTBEAT_ACK_MAX_CHARS as As, ProviderAuthOptionBag as At, hasSyntheticLocalProviderAuthConfig as Au, OpenClawPluginModule as B, PreemptiveCompactionRoute as Ba, resolveEffectiveTtsConfig as Bc, TokenExpiryState as Bd, CliBackendThinkingLevel as Bi, WebSearchProviderToolExecutionContext as Bl, ProviderTransportTurnState as Bn, buildMultimodalChunkForIndexing as Bo, formatInboundFromLabel as Br, appendCronStyleCurrentTimeLine as Bs, ProviderCatalogResult as Bt, ResolvedProviderAuth as Bu, OpenClawPluginApi as C, RealtimeTranscriptionSessionCallbacks as Ca, RuntimeLogger as Cc, upsertAuthProfileWithLock as Cd, PluginToolMetadataRegistration as Ci, ChannelIngressQueueFailedRecord as Cl, ProviderReplaySanitizeMode as Cn, estimateUtf8Bytes as Co, AccessFacts as Cr, emptyPluginConfigSchema as Cs, PluginTranscriptsSourceProviderEntry as Ct, applyLocalNoAuthHeaderOverride as Cu, OpenClawPluginCliRegistrar as D, AgentHarnessAttemptResult as Da, PluginRuntimeTaskRuns as Dc, resolveApiKeyForProfile as Dd, CodexAppServerExtensionRuntime as Di, PluginWebSearchProviderEntry as Dl, ProviderResolveAuthProfileIdContext as Dn, resolveRemoteEmbeddingClient as Do, ChannelTurnRecordOptions as Dr, parseNonNegativeByteSize as Ds, ProviderAuthKind as Dt, getCustomProviderApiKey as Du, OpenClawPluginCliContext as E, AgentHarnessAttemptParams as Ea, PluginRuntimeTaskFlows as Ec, refreshOAuthCredentialForRuntime as Ed, CodexAppServerExtensionFactory as Ei, PluginWebFetchProviderEntry as El, ProviderReplayToolCallIdMode as En, createRemoteEmbeddingProvider as Eo, ChannelTurnDroppedHistoryOptions as Er, listRegisteredMemoryEmbeddingProviderAdapters as Es, ProviderAuthDoctorHintContext as Et, getApiKeyForModel as Eu, OpenClawPluginHttpRouteHandler as F, AgentHarnessSupport as Fa, TaskRunDetail as Fc, resetProviderAuthAliasMapCacheForTest as Fd, CliBackendPrepareExecutionContext as Fi, WebSearchProviderContext as Fl, ProviderRuntimeProviderConfig as Fn, sanitizeEmbeddingCacheHeaders as Fo, ChannelBotLoopProtectionFacts as Fr, ResolvedMemorySearchSyncConfig as Fs, ProviderBuiltInModelSuppressionResult as Ft, resolveProviderEntryApiKeyProfileReference as Fu, OpenClawPluginNodeInvokePolicyApprovalRuntime as G, BuildAgentRuntimePlanParams as Ga, SpeechListVoicesRequest as Gc, ProviderDefaultThinkingPolicyContext as Gd, AgentToolResultMiddlewareContext as Gi, GenerateImageRuntimeResult as Gl, RealtimeTranscriptionProviderPlugin as Gn, normalizeExtraMemoryPaths as Go, DispatchReplyWithDispatcher as Gr, resolveContextEngineOwnerPluginId as Gs, ProviderDiscoveryOrder as Gt, resolveAwsSdkEnvVarName as Gu, OpenClawPluginNodeHostCommand as H, normalizeUsage as Ha, normalizeTtsAutoMode as Hc, CLAUDE_CLI_PROFILE_ID as Hd, PluginTextReplacement as Hi, GenerateVideoParams as Hl, ProviderValidateReplayTurnsContext as Hn, cosineSimilarity as Ho, finalizeInboundContext as Hr, ContextEngineFactory as Hs, ProviderCreateStreamFnContext as Ht, isMissingProviderAuthError as Hu, OpenClawPluginHttpRouteMatch as I, AgentHarnessSupportContext as Ia, TaskRunView as Ic, resolveProviderAuthAliasMap as Id, CliBackendPreparedExecution as Ii, WebSearchProviderId as Il, ProviderSanitizeReplayHistoryContext as In, enforceEmbeddingMaxInputTokens as Io, recordChannelBotPairLoopAndCheckSuppression as Ir, resolveMemorySearchConfig as Is, ProviderCacheTtlEligibilityContext as It, resolveUsableCustomProviderApiKey as Iu, OpenClawPluginNodeInvokeTransportResult as J, HookContext as Ja, SpeechProviderConfiguredContext as Jc, ProviderRuntimeModel as Jd, AgentToolResultMiddlewareOptions as Ji, PromptMode as Jl, TranscriptSourceProvider as Jn, runWithConcurrency as Jo, createReplyDispatcher as Jr, CompactResult as Js, ProviderExtraParamsForTransportResult as Jt, calculateAuthProfileCooldownMs as Ju, OpenClawPluginNodeInvokePolicyContext as K, BeforeToolCallPolicyDiagnosticState as Ka, SpeechModelOverridePolicy as Kc, ProviderThinkingPolicyContext as Kd, AgentToolResultMiddlewareEvent as Ki, EmbeddedRunTrigger as Kl, RealtimeVoiceProviderPlugin as Kn, parseEmbedding as Ko, ReplyDispatcherOptions as Kr, AssembleResult as Ks, ProviderDiscoveryResult as Kt, EnvApiKeyResult as Ku, OpenClawPluginHttpRouteParams as L, CompactEmbeddedAgentSessionParams as La, ResolvedTtsConfig as Lc, resolveProviderIdForAuth as Ld, CliBackendResolveExecutionArgs as Li, WebSearchProviderPlugin as Ll, ProviderSystemPromptContributionContext as Ln, MemoryChunk as Lo, EnvelopeFormatOptions as Lr, resolveMemorySearchSyncConfig as Ls, ProviderCapabilities as Lt, shouldPreferExplicitConfigApiKeyAuth as Lu, OpenClawPluginGatewayRuntimeScopeSurface as M, AgentHarnessResultClassification as Ma, TaskFlowView as Mc, resolveAuthProfileEligibility as Md, CliBackendNativeToolMode as Mi, WebFetchProviderToolDefinition as Ml, ProviderResolveUsageAuthContext as Mn, sanitizeAndNormalizeEmbedding as Mo, InboundMediaFacts as Mr, resolveHeartbeatPrompt as Ms, ProviderBuildMissingAuthMessageContext as Mt, resolveApiKeyForProvider as Mu, OpenClawPluginHostedMediaResolver as N, AgentHarnessSideQuestionParams as Na, TaskRunAggregateSummary as Nc, resolveAuthProfileOrder as Nd, CliBackendNormalizeConfigContext as Ni, WebFetchRuntimeMetadataContext as Nl, ProviderResolveWebSocketSessionPolicyContext as Nn, isMissingEmbeddingApiKeyError as No, PreparedChannelTurn as Nr, stripHeartbeatToken as Ns, ProviderBuildUnknownModelHintContext as Nt, resolveModelAuthMode as Nu, OpenClawPluginCommandDefinition as O, AgentHarnessCompactParams as Oa, PluginRuntimeTasks as Oc, ExternalCliAuthDiscovery as Od, CodexAppServerToolResultEvent as Oi, WebFetchCredentialResolutionSource as Ol, ProviderResolveDynamicModelContext as On, RemoteEmbeddingProviderId as Oo, ChannelTurnResult as Or, withProgress as Os, ProviderAuthMethod as Ot, hasAvailableAuthForProvider as Ou, OpenClawPluginHttpRouteAuth as P, AgentHarnessSideQuestionResult as Pa, TaskRunCancelResult as Pc, ProviderAuthAliasLookupParams as Pd, CliBackendPlugin as Pi, WebSearchCredentialResolutionSource as Pl, ProviderResolvedUsageAuth as Pn, mapBatchEmbeddingsByIndex as Po, RunChannelTurnParams as Pr, ResolvedMemorySearchConfig as Ps, ProviderBuiltInModelSuppressionContext as Pt, resolveProviderEntryApiKeyBinding as Pu, OpenClawPluginSecurityAuditContext as Q, hasBeforeToolCallPolicy as Qa, SpeechProviderPreparedSynthesis as Qc, ProviderExternalOAuthProfile as Qd, REALTIME_VOICE_AUDIO_FORMAT_G711_ULAW_8KHZ as Qi, formatFastModeAutoProgressText as Ql, CreatePluginRuntimeOptions as Qn, buildBatchHeaders as Qo, InternalGetReplyOptions as Qr, ContextEngineInfo as Qs, ProviderFollowupFallbackRouteResult as Qt, markAuthProfileFailure as Qu, OpenClawPluginHttpRouteUpgradeHandler as R, EmbeddedRunAttemptParams as Ra, ResolvedTtsModelOverrides as Rc, AuthCredentialReasonCode as Rd, CliBackendResolveExecutionArgsContext as Ri, WebSearchProviderSetupContext as Rl, ProviderToolSchemaDiagnostic as Rn, MemoryFileEntry as Ro, formatAgentEnvelope as Rr, DEFAULT_AGENT_COMPACTION_RESERVE_TOKENS_FLOOR as Rs, ProviderCatalogContext as Rt, MissingProviderAuthError as Ru, OpenClawPluginAgentEventsApi as S, RealtimeTranscriptionSession as Sa, PluginRuntimeCore as Sc, upsertAuthProfile as Sd, PluginSessionTurnUnscheduleByTagResult as Si, ChannelIngressQueueEnqueueResult as Sl, ProviderReplayPolicyContext as Sn, estimateStructuredEmbeddingInputBytes as So, resolveChannelInboundSupplementalContext as Sr, buildPluginConfigSchema as Ss, PluginTextTransformRegistration as St, applyAuthHeaderOverride as Su, OpenClawPluginCliCommandDescriptor as T, AgentHarness as Ta, BoundTaskRunsRuntime as Tc, listProfilesForProvider as Td, CodexAppServerExtensionContext as Ti, ChannelIngressQueueRecord as Tl, ProviderReplaySessionState as Tn, RemoteEmbeddingClient as To, ChannelTurnAdmission as Tr, listMemoryEmbeddingProviders as Ts, ProviderAuthContext as Tt, createRuntimeProviderAuthLookup as Tu, OpenClawPluginNodeInvokeApprovalDecision as U, isReplaySafeToolCall as Ua, SpeechDirectiveTokenParseContext as Uc, CODEX_CLI_PROFILE_ID as Ud, PluginTextTransforms as Ui, GenerateVideoRuntimeResult as Ul, ProviderWebSocketSessionPolicy as Un, ensureDir as Uo, settleReplyDispatcher as Ur, ContextEngineFactoryContext as Us, ProviderDeferSyntheticProfileAuthContext as Ut, isProviderAuthError as Uu, OpenClawPluginNodeCliFeatureOptions as V, NormalizedUsage as Va, TTS_AUTO_MODES as Vc, hasUsableOAuthCredential as Vd, CliBundleMcpMode as Vi, WebSearchRuntimeMetadataContext as Vl, ProviderUsageAuthToken as Vn, chunkMarkdown as Vo, resolveEnvelopeFormatOptions as Vr, resolveCronStyleNow as Vs, ProviderCreateEmbeddingProviderContext as Vt, formatMissingAuthError as Vu, OpenClawPluginNodeInvokePolicy as W, AgentRuntimePlan as Wa, SpeechDirectiveTokenParseResult as Wc, augmentModelCatalogWithProviderPlugins as Wd, AgentToolResultMiddleware as Wi, GenerateImageParams as Wl, ProviderWrapStreamFnContext as Wn, listMemoryFiles as Wo, DispatchReplyWithBufferedBlockDispatcher$1 as Wr, registerContextEngine as Ws, ProviderDiscoveryContext as Wt, requireApiKey as Wu, OpenClawPluginRunContextApi as X, finalizeToolTerminalPresentation as Xa, SpeechProviderOverrides as Xc, ProviderSystemPromptContribution as Xd, AgentToolResultMiddlewareRuntime as Xi, resolveFastModeState as Xl, UnifiedModelCatalogProviderPlugin as Xn, uploadBatchJsonlFile as Xo, DispatchFromConfigResult as Xr, ContextEngineHostCapability as Xs, ProviderFetchUsageSnapshotContext as Xt, markAuthProfileBlockedUntil as Xu, OpenClawPluginReloadRegistration as Y, ToolOutcomeObserver as Ya, SpeechProviderId as Yc, ProviderRuntimePluginHandle as Yd, AgentToolResultMiddlewareResult as Yi, AgentInternalEvent as Yl, UnifiedModelCatalogProviderContext as Yn, hashText as Yo, createReplyDispatcherWithTyping as Yr, ContextEngine as Ys, ProviderFailoverErrorContext as Yt, clearAuthProfileCooldown as Yu, OpenClawPluginSecurityAuditCollector as Z, getBeforeToolCallPolicyDiagnosticState as Za, SpeechProviderPrepareSynthesisContext as Zc, ProviderExternalAuthProfile as Zd, OpenClawAgentToolResult as Zi, FastModeAutoProgressState as Zl, VideoGenerationProviderPlugin as Zn, BatchHttpClientConfig as Zo, InternalGetReplyFromConfig as Zr, ContextEngineHostRequirements as Zs, ProviderFollowupFallbackRouteContext as Zt, markAuthProfileCooldown as Zu, MigrationSummary as _, RealtimeVoiceToolResultOptions as _a, LlmCompleteCaller as _c, repairOAuthProfileIdMismatch as _d, PluginSessionExtensionRegistration as _i, ChannelIngressQueue as _l, ProviderPrepareRuntimeAuthContext as _n, clearMemoryEmbeddingProviders as _o, FinalizeChannelInboundContextResult as _r, isFileMissingError as _s, PluginRealtimeVoiceProviderEntry as _t, resolveSimpleCompletionSelectionForAgent as _u, ImageGenerationProviderPlugin as a, RealtimeVoiceBridgeEvent as aa, ContextEngineRuntimeReasonCode as ac, ensureAuthProfileStore as ad, MessagingToolSend as af, PluginAgentEventEmitResult as ai, SpeechSynthesisTarget as al, ProviderNormalizeToolSchemasContext as an, consumePreExecutionBlockedToolCall as ao, hasVisibleChannelTurnDispatch as ar, buildEmbeddingBatchGroupOptions as as, PluginCommandContext as at, EmbeddedBlockChunker as au, OpenClawGatewayDiscoveryService as b, RealtimeTranscriptionProviderId as ba, LlmCompleteResult as bc, removeProviderAuthProfilesWithLock as bd, PluginSessionTurnScheduleParams as bi, ChannelIngressQueueCompletedRecord as bl, ProviderReasoningOutputModeContext as bn, buildRemoteBaseUrlPolicy as bo, filterChannelInboundSupplementalContext as br, splitShellArgs as bs, PluginSetupAutoEnableProbe as bt, ProviderEntryApiKeyBindingResolution as bu, MigrationDetection as c, RealtimeVoiceCloseReason as ca, ContextEngineRuntimeSettingsUnsupportedError as cc, findPersistedAuthProfileCredential as cd, HeartbeatToolResponse as cf, PluginRunContextGetParams as ci, TtsDirectiveOverrides as cl, ProviderPlugin as cn, MemoryEmbeddingBatchChunk as co, DurableInboundReplyDeliveryParams as cr, ProviderBatchOutputLine as cs, PluginCommandResult as ct, ExecElevatedDefaults as cu, MigrationItemKind as d, RealtimeVoiceProviderConfiguredContext as da, IngestResult as dc, loadAuthProfileStoreForSecretsRuntime as dd, PluginSessionActionContext as di, OpenClawPluginActiveModelContext as dl, ProviderPluginWizard as dn, MemoryEmbeddingProviderAdapter as do, BuildChannelInboundEventContextAsyncParams as dr, extractBatchErrorMessage as ds, PluginEmbeddingProvider as dt, PreparedSimpleCompletionModel as du, RealtimeVoiceAudioFormat as ea, ContextEngineOperation as ec, resolveProfilesUnavailableReason as ed, ProviderResolveExternalOAuthProfilesContext as ef, ProcessToolDefaults as ei, SpeechProviderResolveTalkConfigContext as el, ProviderModernModelPolicyContext as en, requestDeferredPluginToolApproval as eo, SubagentRunParams as er, BatchCompletionResult as es, OpenClawPluginServiceContext as et, formatFastModeCurrentStatus as eu, MigrationItemStatus as f, RealtimeVoiceProviderId as fa, SubagentEndReason as fc, loadAuthProfileStoreWithoutExternalProfiles as fd, PluginSessionActionRegistration as fi, OpenClawPluginHookOptions as fl, ProviderPluginWizardModelPicker as fn, MemoryEmbeddingProviderCallOptions as fo, BuildChannelInboundEventContextParams as fr, formatUnavailableBatchError as fs, PluginInteractiveHandlerRegistration as ft, PreparedSimpleCompletionModelForAgent as fu, MigrationProviderPreparation as g, RealtimeVoiceToolCallEvent as ga, TranscriptRewriteResult as gc, updateAuthProfileStoreWithLock as gd, PluginSessionExtensionProjection as gi, TaskRecord as gl, ProviderPrepareExtraParamsContext as gn, MemoryEmbeddingProviderRuntime as go, FinalizeChannelInboundContextParams as gr, hasNonTextEmbeddingParts as gs, PluginRealtimeTranscriptionProviderEntry as gt, prepareSimpleCompletionModelForAgent as gu, MigrationProviderPlugin as h, RealtimeVoiceTool as ha, TranscriptRewriteRequest as hc, saveAuthProfileStore as hd, PluginSessionAttachmentResult as hi, OpenClawPluginToolOptions as hl, ProviderPrepareDynamicModelContext as hn, MemoryEmbeddingProviderIndexIdentity as ho, FinalizeChannelInboundContextAsyncParams as hr, EmbeddingInput as hs, PluginLogger as ht, prepareSimpleCompletionModel as hu, AgentPromptSurfaceKind as i, RealtimeVoiceBridgeCreateRequest as ia, ContextEngineRuntimeMode as ic, clearRuntimeAuthProfileStoreSnapshots as id, EmbeddedAgentRunMeta as if, PluginAgentEventEmitParams as ii, SpeechSynthesisStreamResult as il, ProviderNormalizeResolvedModelContext as in, consumeAdjustedParamsForToolCall as io, hasFinalChannelTurnDispatch as ir, EmbeddingBatchExecutionParams as is, OpenClawPluginSessionWorkflowApi as it, BlockReplyChunking as iu, OpenClawPluginGatewayMethod as j, AgentHarnessResetParams as ja, TaskFlowDetail as jc, AuthProfileEligibilityReasonCode as jd, CliBackendExecutionMode as ji, WebFetchProviderPlugin as jl, ProviderResolveTransportTurnStateContext as jn, debugEmbeddingsLog as jo, DispatchedChannelTurnResult as jr, HEARTBEAT_PROMPT as js, ProviderAuthResult as jt, hasUsableCustomProviderApiKey as ju, OpenClawPluginConfigSchema as k, AgentHarnessCompactResult as ka, DetachedTaskFinalizeParams as kc, formatAuthDoctorHint as kd, CodexAppServerToolResultHandlerResult as ki, WebFetchProviderContext as kl, ProviderResolveNonInteractiveApiKeyParams as kn, resolveRemoteEmbeddingBearerClient as ko, CommandFacts as kr, withProgressTotals as ks, ProviderAuthMethodNonInteractiveContext as kt, hasRuntimeAvailableProviderAuth as ku, MigrationItem as l, RealtimeVoiceProviderCapabilities as la, ContextEngineSelectionSource as lc, loadAuthProfileStore as ld, normalizeHeartbeatToolResponse as lf, PluginRunContextPatch as li, TtsDirectiveParseResult as ll, ProviderPluginCatalog as ln, MemoryEmbeddingBatchOptions as lo, DurableInboundReplyDeliveryResult as lr, applyEmbeddingBatchOutputLine as ls, PluginConfigMigration as lt, ExecToolDefaults as lu, MigrationProviderContext as m, RealtimeVoiceRole as ma, TranscriptRewriteReplacement as mc, resolvePersistedAuthProfileOwnerAgentDir as md, PluginSessionAttachmentParams as mi, OpenClawPluginToolFactory as ml, ProviderPreferRuntimeResolvedModelContext as mn, MemoryEmbeddingProviderCreateResult as mo, ChannelInboundSupplementalResolutionOptions as mr, DEFAULT_LOCAL_MODEL as ms, PluginInteractiveRegistration as mt, completeWithPreparedSimpleCompletionModel as mu, AgentPromptGuidance as n, RealtimeVoiceBridge as na, ContextEnginePromptCacheInfo as nc, getSoonestCooldownExpiry as nd, ProviderSyntheticAuthResult as nf, ProviderNormalizeConfigContext as ni, SpeechSynthesisRequest as nl, ProviderNonInteractiveApiKeyResult as nn, setBeforeToolCallDiagnosticsEnabled as no, kernel_d_exports as nr, resolveCompletedBatchResult as ns, OpenClawPluginSessionControlsApi as nt, formatFastModeStatusValue as nu, MediaUnderstandingProviderPlugin as o, RealtimeVoiceBrowserSession as oa, ContextEngineRuntimeSettings as oc, ensureAuthProfileStoreForLocalUpdate as od, MessagingToolSourceReplyPayload as of, PluginAgentEventSubscriptionRegistration as oi, SpeechTelephonySynthesisRequest as ol, ProviderNormalizeTransportContext as on, AgentHarnessTaskRuntimeScope as oo, resolveChannelTurnDispatchCounts as or, runEmbeddingBatchGroups as os, PluginCommandDiagnosticsSession as ot, AgentStreamParams as ou, MigrationPlan as p, RealtimeVoiceProviderResolveConfigContext as pa, SubagentSpawnPreparation as pc, replaceRuntimeAuthProfileStoreSnapshots as pd, PluginSessionActionResult as pi, OpenClawPluginToolContext as pl, ProviderPluginWizardSetup as pn, MemoryEmbeddingProviderCreateOptions as po, BuiltChannelInboundEventContext as pr, createLocalEmbeddingProvider as ps, PluginInteractiveHandlerResult as pt, SimpleCompletionModelOptions as pu, OpenClawPluginNodeInvokePolicyResult as q, DeferredPluginToolApproval as qa, SpeechProviderConfig as qc, ProviderThinkingProfile as qd, AgentToolResultMiddlewareHarness as qi, RunEmbeddedAgentParams as ql, SpeechProviderPlugin as qn, remapChunkLines as qo, ReplyDispatcherWithTypingOptions as qr, BootstrapResult as qs, ProviderExtraParamsForTransportContext as qt, resolveEnvApiKey as qu, AgentPromptGuidanceEntry as r, RealtimeVoiceBridgeCallbacks as ra, ContextEngineRuntimeContext as rc, isProfileInCooldown as rd, EmbeddedAgentCompactResult as rf, ProviderResolveConfigApiKeyContext as ri, SpeechSynthesisStreamRequest as rl, ProviderNormalizeModelIdContext as rn, wrapToolWithBeforeToolCallHook as ro, recordDroppedChannelInboundHistory as rr, throwIfBatchTerminalFailure as rs, OpenClawPluginSessionStateApi as rt, resolveFastModeForElapsed as ru, MigrationApplyResult as s, RealtimeVoiceBrowserSessionCreateRequest as sa, ContextEngineRuntimeSettingsUnavailableError as sc, ensureAuthProfileStoreWithoutExternalProfiles as sd, HEARTBEAT_RESPONSE_TOOL_NAME as sf, PluginControlUiDescriptor as si, SpeechVoiceOption as sl, ProviderOAuthProfileIdRepair as sn, resolveEmbeddedAgentRuntime as so, DurableInboundReplyDeliveryOptions as sr, EMBEDDING_BATCH_ENDPOINT as ss, PluginCommandHandler as st, ClientToolDefinition as su, AGENT_PROMPT_SURFACE_KINDS as t, RealtimeVoiceBargeInOptions as ta, ContextEngineProjection as tc, clearExpiredCooldowns as td, ProviderResolveSyntheticAuthContext as tf, ProviderApplyConfigDefaultsContext as ti, SpeechProviderResolveTalkOverridesContext as tl, ProviderNonInteractiveApiKeyCredentialParams as tn, runBeforeToolCallHook as to, SubagentRunResult as tr, resolveBatchCompletionFromStatus as ts, OpenClawPluginSessionApi as tt, formatFastModeSourceSuffix as tu, MigrationItemAction as u, RealtimeVoiceProviderConfig as ua, IngestBatchResult as uc, loadAuthProfileStoreForRuntime as ud, PluginRuntimeLifecycleRegistration as ui, ResolvedProviderRuntimeAuth as ul, ProviderPluginDiscovery as un, MemoryEmbeddingProvider as uo, deliverInboundReplyWithMessageSendContext as ur, postJsonWithRetry as us, PluginConfigValidation as ut, AgentSimpleCompletionSelection as uu, MusicGenerationProviderPlugin as v, RealtimeTranscriptionProviderConfig as va, LlmCompleteMessage as vc, suggestOAuthProfileIdForLegacyDefault as vd, PluginSessionSchedulerJobHandle as vi, ChannelIngressQueueClaim as vl, ProviderPreparedRuntimeAuth as vn, listRegisteredMemoryEmbeddingProviders as vo, buildChannelInboundEventContext as vr, isPathInside as vs, PluginRegistrationMode as vt, ModelAuthMode as vu, OpenClawPluginChannelRegistration as w, RealtimeTranscriptionSessionCreateRequest as wa, BoundTaskFlowsRuntime as wc, dedupeProfileIds as wd, PluginTrustedToolPolicyRegistration as wi, ChannelIngressQueuePruneOptions as wl, ProviderReplaySessionEntry as wn, fetchRemoteEmbeddingVectors as wo, AssembledChannelTurn as wr, getMemoryEmbeddingProvider as ws, ProviderAugmentModelCatalogContext as wt, canUseProfileAsProviderEntryApiKey as wu, OpenClawPluginAgentApi as x, RealtimeTranscriptionProviderResolveConfigContext as xa, LlmCompleteUsage as xc, setAuthProfileOrder as xd, PluginSessionTurnUnscheduleByTagParams as xi, ChannelIngressQueueCorruptClaim as xl, ProviderReplayPolicy as xn, withRemoteHttpResponse as xo, finalizeChannelInboundContext as xr, buildJsonPluginConfigSchema as xs, PluginSpeechProviderEntry as xt, RuntimeProviderAuthLookup as xu, OpenClawGatewayDiscoveryAdvertiseContext as y, RealtimeTranscriptionProviderConfiguredContext as ya, LlmCompleteParams as yc, markAuthProfileSuccess as yd, PluginSessionSchedulerJobRegistration as yi, ChannelIngressQueueClaimRef as yl, ProviderReasoningOutputMode as yn, registerMemoryEmbeddingProvider as yo, filterChannelInboundQuoteContext as yr, statRegularFile as ys, PluginSetupAutoEnableContext as yt, ProviderCredentialPrecedence as yu, OpenClawPluginLifecycleApi as z, EmbeddedRunAttemptResult as za, TtsConfigResolutionContext as zc, DEFAULT_OAUTH_REFRESH_MARGIN_MS as zd, CliBackendSideQuestionToolMode as zi, WebSearchProviderToolDefinition as zl, ProviderTransformSystemPromptContext as zn, buildFileEntry as zo, formatInboundEnvelope as zr, CronStyleNow as zs, ProviderCatalogOrder as zt, ProviderAuthError as zu };