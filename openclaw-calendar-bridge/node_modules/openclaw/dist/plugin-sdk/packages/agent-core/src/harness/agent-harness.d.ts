import type { AssistantMessage, ImageContent, Model } from "../../../llm-core/src/index.js";
...
export declare class CoreAgentHarness<TSkill extends Skill = Skill, TPromptTemplate extends PromptTemplate = PromptTemplate, TTool extends AgentTool = AgentTool> {
