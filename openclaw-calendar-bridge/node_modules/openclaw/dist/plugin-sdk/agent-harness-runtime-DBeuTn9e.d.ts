import { o as ChannelAgentTool } from "./types.core-FgV7fgOM.js";
...
import { s as PromptImageOrderEntry } from "./types-CVgEq9rw.js";
import { m as PluginHookChannelContext } from "./templating-BduwHz8v.js";
import { i as OpenClawConfig } from "./types.openclaw-BOp7Uumg.js";
import { M as MemoryCitationsMode } from "./types.tools-tYxTcHXF.js";
import { t as OperatorScope } from "./operator-scopes-Phea7r7e.js";
import { P as PluginHookContextWindowSource, X as PluginHookLlmInputEvent, Z as PluginHookLlmOutputEvent, d as PluginHookAgentEndEvent, f as PluginHookBeforeAgentFinalizeEvent, ln as PluginHookBeforeAgentStartResult, u as PluginHookAgentContext } from "./hook-types-H9SC6W-p.js";
import { Ba as PreemptiveCompactionRoute, Ei as CodexAppServerExtensionFactory, Ga as BuildAgentRuntimePlanParams, Gi as AgentToolResultMiddlewareContext, Jd as ProviderRuntimeModel, Js as CompactResult, Ki as AgentToolResultMiddlewareEvent, Kl as EmbeddedRunTrigger, Ks as AssembleResult, Oi as CodexAppServerToolResultEvent, Ra as EmbeddedRunAttemptParams, Ti as CodexAppServerExtensionContext, Va as NormalizedUsage, Wa as AgentRuntimePlan, Wi as AgentToolResultMiddleware, Yd as ProviderRuntimePluginHandle, Ys as ContextEngine, Zi as OpenClawAgentToolResult, af as MessagingToolSend, eo as requestDeferredPluginToolApproval, gc as TranscriptRewriteResult, nc as ContextEnginePromptCacheInfo, oc as ContextEngineRuntimeSettings, rc as ContextEngineRuntimeContext, za as EmbeddedRunAttemptResult } from "./types-Qu2vCWN7.js";
...
import { s as EmbeddedAgentQueueMessageOptions } from "./runs-B5sYnp2T.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-CvTbDVMr.js";
import { n as ContextEngineHostSupport } from "./host-compat-DAFP0Ox4.js";
