import { p as normalizeSecretInputString } from "./types.secrets-Dz8NpNuA.js";
import { t as createAccountStatusSink } from "./channel-lifecycle.core-Mp7J4XZJ.js";
import "./channel-outbound-CsfQazMS.js";
import { t as PAIRING_APPROVED_MESSAGE } from "./pairing-message-DNhqI-OE.js";
import "./accounts-eCsj6Gt_.js";
import "./runtime-api-CDzklCl9.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-CnqT_OIq.js";
import { t as sendMessageZalo } from "./send--a1lvpLI.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-Dx3xl4Fe.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-C8Kemwjw.js");
