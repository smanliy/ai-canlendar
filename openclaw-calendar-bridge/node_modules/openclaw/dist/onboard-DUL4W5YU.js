...
import { f as resolveGatewayPort } from "./paths-CViT2Nwu.js";
import { t as formatCliCommand } from "./command-format-2N79m0dg.js";
import { t as restoreTerminalState } from "./restore-BWpek1U9.js";
import { m as resolveUserPath } from "./utils-B8fk9j7G.js";
import { d as isValidEnvSecretRefId, g as resolveSecretInputRef } from "./types.secrets-Dz8NpNuA.js";
...
import { t as resolveConfiguredSecretInputString } from "./resolve-configured-secret-input-string-DdCsi4oG.js";
import { t as resolveGatewayAuthToken } from "./auth-token-resolution-BRr58XQa.js";
import { u as readConfigFileSnapshot } from "./io-ol5Bj12B.js";
...
import { t as createClackPrompter } from "./clack-prompter-DQXjh1nB.js";
import { r as logConfigUpdated } from "./logging-5LsDzDf7.js";
import { a as stripPendingPluginInstallRecords, i as hasPendingPluginInstallRecords, n as commitConfigWriteWithPendingPluginInstalls, s as unchangedPendingPluginInstallRecordIds } from "./plugins-install-record-commit-Fc4xp_dZ.js";
import { c as normalizeGatewayTokenInput, m as waitForGatewayReachable, n as applyWizardMetadata, o as handleReset, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE } from "./onboard-helpers-Q7Fd1spr.js";
import { i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-C8N8hp0h.js";
import { n as applySkipBootstrapConfig, t as applyLocalSetupWorkspaceConfig } from "./onboard-config-CIz8j2VZ.js";
import { t as createNonInteractiveLoggingPrompter } from "./non-interactive-prompter-DLCGsi38.js";
import { t as runSetupWizard } from "./setup-BYZ1oYa6.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	const diagnostics = {};
	try {
		const { resolveGatewayService } = await import("./service-Gcw5XW7h.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	const inferredAuthChoice = opts.authChoice ? void 0 : (await import("./auth-choice-inference-Cccx9tIm.js")).inferAuthChoiceFromFlags(opts, {
		config: nextConfig,
		workspaceDir,
		env: process.env
	});
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-D9thpSxK.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-CJSAI6Np.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-Z_53GdI1.js");
...
async function runNonInteractiveMigrationImport(params) {
	...
	const { detectSetupMigrationSources, runSetupMigrationImport } = await import("./setup.migration-import-BGwGUZHo.js");
