...
import { f as normalizeResolvedSecretInputString, s as coerceSecretRef } from "./types.secrets-Dz8NpNuA.js";
import { n as normalizeAccountId, r as normalizeOptionalAccountId } from "./account-id-5IgE9UKY.js";
import { n as retryAsync } from "./retry-D8tUl08r.js";
import "./error-runtime-DPV9xD4T.js";
import "./number-runtime-CHdXliRa.js";
import { t as requireRuntimeConfig } from "./plugin-config-runtime-BGRqJXIz.js";
import { o as isPrivateNetworkOptInEnabled, u as ssrfPolicyFromDangerouslyAllowPrivateNetwork } from "./ssrf-policy-DqwSPpuy.js";
import "./ssrf-runtime-CyHVBDtR.js";
import "./retry-runtime-DgyQBK_5.js";
import "./secret-input-runtime-BNGGdUyD.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-D-CuEKGu.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-DB8tSKUw.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-DWEvfb7j.js";
...
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-Dblwrjr4.js";
import { s as repairCurrentTokenStorageMetaDeviceId } from "./storage-DntHGZmv.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-D48392Lx.js"), import("./logging-BVMWgOns.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-2IalIBSh.js").then((credentialsReadModule) => ({
