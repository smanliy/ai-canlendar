...
import { a as isApprovalMethod } from "./method-scopes-DcXfJgyz.js";
...
import { t as createOperatorApprovalsGatewayClient } from "./operator-approvals-client-D-qZ2If8.js";
...
function createChannelNativeApprovalRuntime(adapter) {
	...
	const routeReporter = createApprovalNativeRouteReporter({
		...
		requestGateway: async (method, params) => {
			const { callGatewayLeastPrivilege } = await import("./call-CAaf-54P.js");
