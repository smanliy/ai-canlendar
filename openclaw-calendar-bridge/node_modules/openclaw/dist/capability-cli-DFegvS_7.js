...
import { a as resolveAgentDir, c as resolveDefaultAgentId } from "./agent-scope-config-DrIvffiJ.js";
import { i as isLoopbackHost } from "./net-DQvRbvSK.js";
import { i as getRuntimeConfig } from "./io-ol5Bj12B.js";
import { t as getProviderEnvVars } from "./provider-env-vars-QbSDH-cE.js";
import { r as DEFAULT_PROVIDER } from "./defaults-CdX9UGcX.js";
import { p as normalizeThinkLevel } from "./thinking-C5tIz6Fu.js";
...
import { _ as randomIdempotencyKey, c as callGateway } from "./call-wfHuMIBZ.js";
import { t as buildGatewayConnectionDetailsWithResolvers } from "./connection-details-gICKvpFk.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-CS3xdS-V.js";
import { c as loadAuthProfileStoreForRuntime, m as updateAuthProfileStoreWithLock } from "./store-CblTQJ3s.js";
import { E as listMemoryEmbeddingProviders } from "./registry-BiuJAn1Z.js";
...
import { n as listProfilesForProvider } from "./profile-list-CRr6Hxey.js";
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-DB7KYry1.js";
import { n as loadModelCatalog } from "./model-catalog-CasmUbPv.js";
import { l as getImageMetadata, s as convertHeicToJpeg } from "./media-services-CG1_-bAI.js";
import { u as saveMediaBuffer } from "./store-BJmiXr3Z.js";
import { d as resolveApiKeyForProvider } from "./model-auth-ByDTM2Nc.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-bi_VK5xA.js";
import { r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-RHpfttuD.js";
import { t as buildExplicitSessionIdSessionKey } from "./session-CXOziEGK.js";
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-GWuyTF8g.js";
import { a as getCapabilityWebSearchCommandSecretTargets, c as getMemoryEmbeddingCommandSecretTargetIds, l as getModelsCommandSecretTargetIds, m as getTtsCommandSecretTargetIds, r as getCapabilityWebFetchCommandSecretTargets } from "./command-secret-targets-Bmc8nvVi.js";
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-CSmD3En6.js";
import { o as listSpeechProviders, r as canonicalizeSpeechProviderId } from "./directives-R5R776ep.js";
import { S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, d as listSpeechVoices, f as listTtsPersonas, g as resolveTtsConfig, k as textToSpeech, m as resolveExplicitTtsOverrides, o as getTtsPersona, s as getTtsProvider, w as setTtsPersona } from "./tts-runtime-OSxlwLhg.js";
import "./tts-CzxWUN6q.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-Czo02idp.js";
import { a as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-Cfmjfgea.js";
import { n as listEmbeddingProviders } from "./embedding-provider-runtime-CFId0jef.js";
import { t as resolveMemorySearchConfig } from "./memory-search-CIfj3J5L.js";
import { n as listWebFetchProviders, r as resolveWebFetchDefinition, t as isWebFetchProviderConfigured } from "./runtime-kzX6gktD.js";
...
import { t as collectOption } from "./helpers-DNq_1_si.js";
import { n as describeImageFileWithModel, o as transcribeAudioFile, r as describeVideoFile, t as describeImageFile } from "./runtime-pR0MFi-f.js";
import { t as createEmbeddingProvider } from "./memory-core-bundled-runtime-BUct8MW7.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-DI0f4yyk.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-DFx01le5.js");
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").option("--method <id>", "Provider auth method id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-2F_VOsiB.js");
