...
import { c as hasConfiguredSecretInput } from "./types.secrets-Dz8NpNuA.js";
...
import { i as createActionGate } from "./common-CiyB9F5_.js";
...
import { i as createChatChannelPlugin, t as buildChannelOutboundSessionRoute, u as stripChannelTargetPrefix } from "./core-CuT-btUr.js";
import "./channel-core-biC-Awr0.js";
import "./routing-CLSQ7EtM.js";
import { r as buildSecretInputSchema } from "./secret-input-Du5Tq7Dz.js";
import { t as formatAllowFromLowercase } from "./allow-from-cFRuT4xz.js";
import { E as projectConfigAccountIdWarningCollector, g as createAllowlistProviderGroupPolicyWarningCollector } from "./channel-policy-BuAsV60R.js";
...
import { D as patchTopLevelChannelConfigSection, P as promptSingleChannelSecretInput, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-AOU0sR5E.js";
import "./setup-BLf5KHrP.js";
...
import { T as defineChannelMessageAdapter } from "./channel-outbound-CsfQazMS.js";
...
import { d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-BIrxMHAX.js";
...
import "./state-paths-B4xynmtr.js";
import { a as resolveDefaultFeishuAccountId, i as listFeishuAccountIds, l as resolveFeishuRuntimeAccount, n as inspectFeishuCredentials, p as isRecord$1, r as listEnabledFeishuAccounts, s as resolveFeishuAccount } from "./accounts-CT0uPrw7.js";
import { n as looksLikeFeishuId, r as normalizeFeishuTarget } from "./targets-owJLEkw6.js";
import { n as createFeishuSendReceipt } from "./send-result-DMN3FNBJ.js";
import { a as parseFeishuTargetId, i as parseFeishuDirectConversationId, n as buildFeishuModelOverrideParentCandidates, r as parseFeishuConversationId, t as buildFeishuConversationId } from "./conversation-id-B_Ar1gk9.js";
import { i as listFeishuDirectoryPeers, r as listFeishuDirectoryGroups, t as buildFeishuPresentationCard } from "./presentation-card-CYaN5-uG.js";
import { t as messageActionTargetAliases } from "./security-audit-uEZ1GjeY.js";
import { s as resolveFeishuGroupToolPolicy } from "./policy-B-qViPJ1.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-C_2qY2TC.js";
import { t as collectFeishuSecurityAuditFindings } from "./security-audit-shared-YBbX4r0e.js";
import { t as resolveFeishuSessionConversation } from "./session-conversation-If9GUAf6.js";
...
const loadAppRegistrationModule = async () => {
	appRegistrationModulePromise ??= import("./app-registration-CiJdtxis.js");
	...
	status: {
		...
		resolveStatusLines: async ({ cfg, accountId, configured }) => {
			...
			if (configured && account.configured) try {
				const { probeFeishu } = await import("./probe-Bi6mrqt8.js");
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-COJxcU8M.js"), "feishuChannelRuntime");
...
async function createFeishuActionClient(account) {
	const { createFeishuClient } = await import("./client-BzJSthcV.js");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-OUlqEuZs.js");
