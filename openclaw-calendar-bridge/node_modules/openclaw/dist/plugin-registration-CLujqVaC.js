...
import { t as BrowserToolSchema } from "./browser-tool.schema-BYm1cd2u.js";
...
function createLazyBrowserPluginService() {
	...
	return {
		...
		stop: async (ctx) => {
			if (!service) {
				const { stopBrowserControlService } = await import("./control-service-D1CssMp0.js");
...
function registerBrowserPlugin(api) {
	...
	api.registerCli(async ({ program }) => {
		const { registerBrowserCli } = await import("./browser-cli-DUt8WRJJ.js");
