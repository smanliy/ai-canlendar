...
import { t as parsePort } from "./parse-port-B_mbWwQY.js";
import { o as resolveProviderOnboardAuthFlags } from "./provider-auth-choices-Di_lf4zz.js";
import { n as runCommandWithRuntime } from "./cli-utils-vw1ExnI7.js";
import { r as formatAuthChoiceChoicesForCli } from "./auth-choice-options-BOi32F2W.js";
...
function registerOnboardCommand(program) {
	...
	command.action(async (opts, commandRuntime) => {
		...
		await runCommandWithRuntime(defaultRuntime, async () => {
			...
			const { setupWizardCommand } = await import("./onboard-DUL4W5YU.js");
