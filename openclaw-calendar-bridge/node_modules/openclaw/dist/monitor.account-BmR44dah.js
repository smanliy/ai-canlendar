...
import { n as isAbortRequestText } from "./abort-primitives-C0A3ncun.js";
import { d as stripReasoningTagsFromText } from "./assistant-visible-text-BdVjc-xz.js";
import { g as sendMediaWithLeadingCaption, h as resolveTextChunksWithFallback, m as resolveSendableOutboundReplyParts } from "./reply-payload-DiFDcheB.js";
import { a as resolveInboundLastRouteSessionKey, i as resolveAgentRoute } from "./resolve-route-DzJjy-DE.js";
...
import { s as formatChannelProgressDraftLineForEntry, u as isChannelProgressDraftWorkToolName } from "./streaming-C2YINyhE.js";
import { h as resolveChannelConfigWrites } from "./channel-config-helpers-CMg35hQR.js";
import { s as formatReasoningMessage } from "./embedded-agent-utils-rLCqDcMr.js";
...
import "./text-chunking-RiLj8Q34.js";
import "./routing-CLSQ7EtM.js";
import { E as toInboundMediaFacts, y as buildChannelInboundEventContext } from "./kernel-HSxUlMd6.js";
import "./history-CyeY-X3N.js";
import { t as createReplyPrefixContext } from "./reply-prefix-9VMyo301.js";
import { t as createChannelReplyPipeline } from "./reply-pipeline-Cw_vNflC.js";
import { t as createChannelHistoryWindow } from "./history-window-BdeDJF3-.js";
...
import { n as isBtwRequestText } from "./btw-command-BRYAyrAW.js";
import "./channel-outbound-CsfQazMS.js";
import { n as resolveAgentOutboundIdentity } from "./identity-CP8PE3wA.js";
import { r as logTypingFailure } from "./logging-gUWPKC5g.js";
import { i as installRequestBodyLimitGuard } from "./http-body-ChCNIAfB.js";
import "./ssrf-runtime-CyHVBDtR.js";
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute, t as ensureConfiguredBindingRouteReady } from "./binding-routing-CnZaYBS7.js";
import "./conversation-runtime-C76rIyGP.js";
import "./agent-runtime-NAL5a1H9.js";
import "./command-primitives-runtime-DF-d6yHi.js";
import "./channel-inbound-P2Fbxc2p.js";
import "./channel-feedback-CW9XXWBe.js";
import { n as createChannelPairingController } from "./channel-pairing-DuxE03DU.js";
import { c as readWebhookBodyOrReject, r as applyBasicWebhookRequestGuards } from "./webhook-request-guards-CWpZk0Kj.js";
import "./webhook-ingress-D0g5934s.js";
import { _ as requestFeishuApi, d as extractReplyText, g as readString, h as parseCommentContentElements, l as resolveFeishuRuntimeAccount, m as normalizeString, p as isRecord$1, s as resolveFeishuAccount, u as encodeQuery, v as buildFeishuCommentTarget, y as normalizeCommentFileType } from "./accounts-CT0uPrw7.js";
import { i as resolveReceiveIdType } from "./targets-owJLEkw6.js";
import { c as decodeFeishuCardAction, o as buildFeishuCardActionTextFallback, s as createFeishuCardInteractionEnvelope } from "./send-result-DMN3FNBJ.js";
import { t as buildFeishuConversationId } from "./conversation-id-B_Ar1gk9.js";
import { a as resolveFeishuGroupConversationIngressAccess, c as resolveFeishuReplyPolicy, i as resolveFeishuGroupConfig, n as normalizeFeishuAllowEntry, o as resolveFeishuGroupSenderActivationIngressAccess, r as resolveFeishuDmIngressAccess, t as hasExplicitFeishuGroupConfig } from "./policy-B-qViPJ1.js";
import { t as getFeishuRuntime } from "./runtime-BP4XWQ9i.js";
import { a as getFeishuUserAgent, i as createFeishuWSClient, n as createEventDispatcher, r as createFeishuClient } from "./client-CpS44Igy.js";
import { c as getChatInfo, i as createCommentTypingReactionLifecycle, t as deliverCommentThreadText } from "./drive-Pzh_ZkFC.js";
import { t as createFeishuThreadBindingManager } from "./thread-bindings-av91014A.js";
import "./runtime-api-CPUFFIYH.js";
import { _ as normalizeFeishuExternalKey, a as sendCardFeishu, c as sendStructuredCardFeishu, d as isFeishuBroadcastMention, f as isMentionForwardRequest, g as shouldSuppressFeishuTextForVoiceMedia, h as sendMediaFeishu, i as resolveFeishuCardTemplate, l as parsePostContent, m as saveMessageResourceFeishu, n as getMessageFeishu, p as isFeishuGroupChatType, r as listFeishuThreadMessages, s as sendMessageFeishu, u as extractMentionTargets } from "./send-DTUcBwuA.js";
import { i as waitForAbortableDelay, r as raceWithTimeoutAndAbort } from "./probe-DnMIntO6.js";
import { a as clearFeishuBotIdentityState, c as httpServers, d as wsClients, f as fetchBotIdentityForMonitor, i as botOpenIds, l as recordWebhookStatus, n as FEISHU_WEBHOOK_MAX_BODY_BYTES, o as closeTrackedFeishuHttpServer, r as botNames, s as feishuWebhookRateLimiter, t as FEISHU_WEBHOOK_BODY_TIMEOUT_MS, u as setFeishuBotIdentityState } from "./monitor.state-BUZFts4I.js";
...
async function resolveDriveCommentEventCore(params) {
	...
	const context = await fetchDriveCommentContext({
		client: createClient ? createClient(account ?? { accountId }) : createFeishuClient((await import("./accounts-BDuisiGA.js")).resolveFeishuAccount({
			cfg,
			accountId
		})),
		fileToken,
...
async function resolveReactionSyntheticEvent(params) {
	...
	const { resolveFeishuAccount } = await import("./accounts-BDuisiGA.js");
