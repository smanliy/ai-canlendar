...
import { n as updateMatrixAccountConfig, t as resolveMatrixConfigPath } from "./config-update-CT7GPA1F.js";
import { n as matrixSetupAdapter } from "./setup-core-B_s-e9mT.js";
import { t as withResolvedActionClient } from "./client-CFtUJ-nH.js";
import { r as resolveMatrixAuthContext } from "./config-CPA8ieNh.js";
...
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-DC8DUakq.js";
...
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-NSjAUlVA.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-CkG765AU.js");
	return matrixActionClientModulePromise;
}
function loadMatrixDirectManagementModule() {
	matrixDirectManagementModulePromise ??= import("./direct-management-ChECr9Bf.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-c5Fu6JUE.js");
