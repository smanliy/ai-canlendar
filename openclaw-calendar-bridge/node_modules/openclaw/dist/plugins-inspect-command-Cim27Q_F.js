...
import { a as tracePluginLifecyclePhaseAsync, i as tracePluginLifecyclePhase } from "./discovery-CCTiTuwj.js";
...
async function runPluginsInspectCommand(id, opts) {
	const { buildAllPluginInspectReports, buildPluginDiagnosticsReport, buildPluginInspectReport, buildPluginSnapshotReport, formatPluginCompatibilityNotice } = await import("./status-BsWT-xqP.js");
	const { loadInstalledPluginIndexInstallRecords } = await import("./installed-plugin-index-records-DWptMOvC.js");
