...
import { d as ReplyDeliveryContext, f as ReplyPayload } from "./types-aDPHlzlU.js";
import { _ as InboundEventKind, i as MsgContext } from "./templating-tUoj52l0.js";
...
type ChannelMessagingAdapter = {
  ...
  targetResolver?: {
    ...
    hint?: string; /** Bare words that are command/session references, not literal destinations. */
