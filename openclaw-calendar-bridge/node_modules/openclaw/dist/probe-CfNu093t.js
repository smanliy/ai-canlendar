...
import { n as GatewayClient, r as GatewayClientRequestError, u as loadDeviceAuthToken } from "./client-Q56zSyDo.js";
...
async function probeGateway(opts) {
	...
	const deviceIdentity = await (async () => {
		try {
			...
			const { loadDeviceIdentityIfPresent } = await import("./device-identity-DcmtMbbS.js");
