import { A as resolvePositiveTimerTimeoutMs, j as resolveTimerTimeoutMs } from "./number-coercion-Crk_c9KW.js";
...
import { t as probePortUsage } from "./ports-probe-DKtABrIF.js";
...
function listPortListeners(port) {
	if (process.platform === "win32") try {
		const lines = execFileSync(getWindowsSystem32ExePath("netstat.exe"), [
			"-ano",
			"-p",
			"TCP"
