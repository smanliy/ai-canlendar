...
export class AgentSideConnection {
    ...
    createTerminal(params) {
        return this.connection.sendRequest(schema.CLIENT_METHODS.terminal_create, params, (response) => new TerminalHandle(response.terminalId, params.sessionId, this.connection));
    }
    /**
     * **UNSTABLE**
     *
...
export class ClientSideConnection {
     ...
     */
    closeSession(params) {
        return this.connection.sendRequest(schema.AGENT_METHODS.session_close, params);
    }
    /**
    ...
    unstable_setSessionModel(params) {
        return this.connection.sendRequest(schema.AGENT_METHODS.session_set_model, params, emptyObjectResponse);
    }
    /**
