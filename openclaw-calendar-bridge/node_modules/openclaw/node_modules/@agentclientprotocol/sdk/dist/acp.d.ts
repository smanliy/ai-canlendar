...
export declare class ClientSideConnection implements Agent {
     ...
     * @experimental
     */
    unstable_deleteSession(params: schema.DeleteSessionRequest): Promise<schema.DeleteSessionResponse>;
    /**
...
export interface Agent {
     ...
     * @experimental
     */
    unstable_deleteSession?(params: schema.DeleteSessionRequest): Promise<schema.DeleteSessionResponse | void>;
    /**
     * Resumes an existing session without returning previous messages.
     *
     * This method is only available if the agent advertises the `session.resume` capability.
